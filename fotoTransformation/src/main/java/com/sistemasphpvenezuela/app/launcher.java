...
public static void resizer(File orignalImage,int width,int height,String extension,int marcador) {
        ...
        try {
              ...
              g.dispose();
              //System.out.println(orignalImage.getAbsolutePath().substring(0,orignalImage.getAbsolutePath().lastIndexOf("fotoTransformation"))+"\\out");
              //System.out.println(orignalImage.getAbsolutePath().substring(0,orignalImage.getAbsolutePath().lastIndexOf(".")));
            System.out.println("original path: "+orignalImage.getAbsolutePath());
             
              String newFile = orignalImage.getAbsolutePath().substring(0,orignalImage.getAbsolutePath().lastIndexOf("app"))+"\\app\\out\\"+String.valueOf(marcador)+"_"+width+"x"+height+"."+extension;
